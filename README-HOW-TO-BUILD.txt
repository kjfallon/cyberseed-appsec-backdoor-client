...
then executed in a Java Virtual Machine (JVM).

We have made this very simple to do using Maven which is the most popular build tool for Java. Maven will download
...
You cannot compile Java code without a Java compiler to compile it.  The Java 8 JDK is what the Java 8
...
Maven is a build system which makes compiling this project drop-dead simple.  When you tell this project to compile
...
In the root directory of this project is a shell script named build.sh.  This script contains one line with four words
